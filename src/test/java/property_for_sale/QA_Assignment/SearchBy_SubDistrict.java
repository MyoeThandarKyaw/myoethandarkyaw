...
public class SearchBy_SubDistrict {
	WebDriver driver;
	public static final String URL = "https://www.fazwaz.com/property-for-sale/thailand";
	public static final String searchSubDisctrictName = "Wong Sawang";
	...
	public void searchProvinceName() throws InterruptedException {
		...
		searchBox.sendKeys(searchSubDisctrictName);
		Thread.sleep(3000);
		...
		Assert.assertTrue(actualResult.contains(searchSubDisctrictName));
