...
public class SearchBy_Project {
	WebDriver driver;
	public static final String URL = "https://www.fazwaz.com/property-for-sale/thailand";
	public static final String searchProjectName = "The Line Wongsawang";
	...
	public void searchProvinceName() throws InterruptedException {
		...
		WebElement searchResult = driver.findElement(By.xpath("/html/body/div[1]/main/div[3]/div[1]/h1"));
		Thread.sleep(2000);
		//searchResult.click();
		String actualResult = searchResult.getText();
		System.out.println(actualResult);
		Assert.assertTrue(actualResult.contains(searchProjectName));
